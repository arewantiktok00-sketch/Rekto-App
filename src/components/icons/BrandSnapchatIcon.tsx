...
/** Snapchat brand icon — from brand-snapchat.svg (Tabler). */
const PATH_SNAPCHAT =
...
export function BrandSnapchatIcon({ size = 24, color = '#FFFC00' }: { size?: number; color?: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
      <Path fill={color} d={PATH_SNAPCHAT} />
    </Svg>
  );
}
